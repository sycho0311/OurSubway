...
<%
	String sql = "SELECT name, password, title, content FROM contact WHERE num=" + num;
...
<form name=modifyform method=post action="/OurSubway/contact/modify_ok.jsp?num=<%=num%>">
<table>
	<tr>
		<td></td>
