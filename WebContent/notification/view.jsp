...
<%
	String sql = "SELECT name, title, content, date, hit FROM notification WHERE num=" + num;
			...
			<table>
				...
				<tr align="center">
					...
					<td colspan="2" width="399">
						<a href="/OurSubway/index.jsp?main=notification"><input type="button" value="목록"></a>
<%
	// 관리자만 글을 관리할 수 있다
	String masterID = (String)session.getAttribute("userID");
	if (masterID != null && masterID.equals("subwaymaster")) {
%>
						<a href="/OurSubway/index.jsp?main=notification_write"><input type="button" value="글쓰기"></a>
						<a href="/OurSubway/index.jsp?main=notification_modify&num=<%=num%>"><input type="button" value="수정"></a>
						<a href="/OurSubway/index.jsp?main=notification_delete&num=<%=num %>"><input type="button" value="삭제"></a>
<%
	}
%>
					<td></td>
...
<%
		sql = "UPDATE notification SET hit=" + hit + " WHERE num=" + num;
