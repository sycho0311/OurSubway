...
<%
	...
	String sql = "SELECT name, password, title, content FROM notification WHERE num=" + num;
...
<form name=modifyform method=post action="/OurSubway/notification/modify_ok.jsp?num=<%=num%>">
<table>
	<tr>
		<td></td>
