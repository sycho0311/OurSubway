...
<% 
	/* 게시물 개수 */
	String count = "SELECT count(*) FROM notification";
	...
	/* 게시물 가져오기 */
	String record = "SELECT num, title, name, date, hit FROM notification ORDER BY num DESC LIMIT " + page_num + ", " + max;
	res = statement.executeQuery(record);
%>

<table>
	<tr align="center"><td colspan="7"><font size="10em" color="#173068">공지사항</font></td></tr>
...
%>
	...
	<tr height="25" align="center" >
		...
		<td align="left"><a href="/OurSubway/index.jsp?main=notification_content&num=<%=num%>"><%=title %></a></td>
...
%>
				<a href="/OurSubway/index.jsp?main=notification&page=<%=i * max%>"><%=i+1%></a>
<%
			}
		} // else문 종료
...
%>
	<table>
		<tr><td></td></tr>
		<tr>
			<td><input type="button" value="글쓰기" onClick="window.location='/OurSubway/index.jsp?main=notification_write'"/></td>
		</tr>
		<tr><td></td></tr>
	</table>
<%
